    ...
    <div className="flex flex-col lg:flex-row min-h-[500px] sm:min-h-[600px]">
      ...
      <div className="flex-1 flex items-center justify-center px-4 sm:px-8 lg:px-12 py-10 sm:py-16 lg:py-20">
        <div className="w-full max-w-[400px] sm:max-w-[480px]">
          <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-black mb-2">Log in to Exclusive</h1>
          <p className="text-sm sm:text-base text-black mb-6 sm:mb-12">Enter your details below</p>
          ...
          <form onSubmit={handleSubmit} className="space-y-8 sm:space-y-10">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 sm:gap-6">
              <button type="submit" className="w-full sm:w-36 h-11 sm:h-14 bg-primary text-white font-semibold rounded text-sm sm:text-base hover:bg-primary-hover transition-colors btn-tactile btn-shadow-lift btn-primary-glow">
                Log In
              </button>
              <button type="button" className="text-sm sm:text-base text-primary hover:underline btn-tactile">
                Forget Password?
              </button>
            </div>
          </form>
          ...
          <p className="text-center mt-6 sm:mt-8 text-xs sm:text-sm">
            ...
            <Link to="/sign-up" className="text-black font-medium underline hover:text-primary">Sign up</Link>
          </p>
        </div>
      </div>
    </div>
