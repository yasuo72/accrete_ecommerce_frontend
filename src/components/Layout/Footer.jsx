        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-8 lg:gap-10 mb-10">
          ...
          <div>
            ...
            <div className="flex gap-3 items-center mb-4 sm:mb-6">
              {/* QR placeholder */}
              <div className="w-16 sm:w-20 h-16 sm:h-20 bg-white rounded flex items-center justify-center text-2xl sm:text-3xl text-black">📱</div>
            ...
            <div className="flex gap-3 sm:gap-4">
              <a href="#" className="p-1 hover:text-primary transition-colors"><Facebook size={20} /></a>
              <a href="#" className="p-1 hover:text-primary transition-colors"><Twitter size={20} /></a>
              <a href="#" className="p-1 hover:text-primary transition-colors"><Instagram size={20} /></a>
              <a href="#" className="p-1 hover:text-primary transition-colors"><Linkedin size={20} /></a>
            </div>
          </div>
        </div>
